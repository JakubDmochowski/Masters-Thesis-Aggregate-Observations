...
from data.tabular.monks import MonksDataGraph, get_testing_data, get_training_data, get_weights, get_data_count
...
RESULT_FILENAME = os.getcwd() + '/research_results/monks_gbm_results.csv'
...
for iteration in range(5):
    ...
    for NUM_GENERATED_USED in [1*NUM_INITIAL, 4*NUM_INITIAL, 16*NUM_INITIAL]:
        ...
        generated_data_file_path = os.getcwd() + '\\gen_tabular_monks_generated_big_cliques.csv'
        ...
        def preprocess_labels(z):
            ...
            def fitness(k):
                ...
                return abs(np.count_nonzero(vals > 0.5) - (len(z) / 2))
