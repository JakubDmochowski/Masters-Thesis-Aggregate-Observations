...
RESULT_FILENAME = os.getcwd() + '/research_results/spect_xbnet_results.csv'
...
for iteration in range(5):
    ...
    for NUM_GENERATED_USED in [1*NUM_INITIAL, 4*NUM_INITIAL, 16*NUM_INITIAL]:
        ...
        generated_data_file_path = os.getcwd() + f"\\gen_tabular_spect_generated_big_cliques_it_{iteration}.csv"
